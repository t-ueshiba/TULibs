...
#   TUCUDAPP_INCLUDE_PATH,	TUCUDAPP_LIB,	TUCUDAPP_FOUND
...
if (UNIX)
  ...
  find_path(TUCUDAPP_INCLUDE_PATH TU/cuda/Array++.h ${TULIBS_INC_SEARCH_PATH})
  find_library(TUCUDAPP_LIB	  TUCuda++	    ${TULIBS_LIB_SEARCH_PATH})

  if(TUCUDAPP_LIB AND TUCUDAPP_INCLUDE_PATH)
    set(TUCUDAPP_FOUND TRUE)
    set(TULIBS_INCLUDE_DIR ${TULIBS_INCLUDE_DIR} ${TUCUDAPP_INCLUDE_PATH})
  endif()
