...
if (UNIX)
  ...
  if(TUTOOLS_LIB AND TUTOOLS_INCLUDE_PATH)
    ...
    set(TULIBS_INCLUDE_DIR ${TULIBS_INCLUDE_DIR} ${TUTOOLS_INCLUDE_PATH})
  endif()
  ...
  if(TUV_LIB AND TUV_INCLUDE_PATH)
    set(TUV_FOUND TRUE)
    set(TULIBS_INCLUDE_DIR ${TULIBS_INCLUDE_DIR} ${TUV_INCLUDE_PATH})
  endif()
  ...
  if(TUIIDC_LIB AND TUIIDC_INCLUDE_PATH)
    ...
    set(TULIBS_INCLUDE_DIR ${TULIBS_INCLUDE_DIR} ${TUIIDC_INCLUDE_PATH})
  endif()
  ...
  if(TUV4L2_LIB AND TUV4L2_INCLUDE_PATH)
    ...
    set(TULIBS_INCLUDE_DIR ${TULIBS_INCLUDE_DIR} ${TUV4L2_INCLUDE_PATH})
  endif()
  ...
  if(TUVIIDC_LIB AND TUVIIDC_INCLUDE_PATH)
    ...
    set(TULIBS_INCLUDE_DIR ${TULIBS_INCLUDE_DIR} ${TUVIIDC_INCLUDE_PATH})
  endif()
  ...
  if(TUVV4L2_LIB AND TUVV4L2_INCLUDE_PATH)
    ...
    set(TULIBS_INCLUDE_DIR ${TULIBS_INCLUDE_DIR} ${TUVV4L2_INCLUDE_PATH})
  endif()
  ...
  if(TUCUDA_LIB AND TUCUDA_INCLUDE_PATH)
    ...
    set(TULIBS_INCLUDE_DIR ${TULIBS_INCLUDE_DIR} ${TUCUDA_INCLUDE_PATH})
  endif()
